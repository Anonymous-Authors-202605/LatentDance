...
def add_training_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--train_batch_size", type=int, default=1, help="Training batch size per GPU. When > 1, multiple samples are loaded per step and losses are averaged.")
